    ...
    <div className="bg-slate-900/95 backdrop-blur-md border border-slate-800 rounded-2xl p-4 shadow-2xl space-y-4 z-20 animate-in fade-in slide-in-from-top-2 duration-200">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
        <h3 className="text-sm font-bold text-white flex items-center gap-2">
          <span>Filter Lanjutan Live Tracking</span>
        </h3>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3 text-xs">
        {/* Status */}
        <div>
          <label className="block text-slate-400 font-mono mb-1">Status Lokasi</label>
          <select
          ...
          >
            ...
            <option value="Stopped">Stopped (Parkir)</option>
            <option value="Idle">Idle (Mesin Nyala)</option>
        ...
        {/* Group */}
        <div>
          <label className="block text-slate-400 font-mono mb-1">Grup Armada</label>
          <select
          ...
          >
            ...
            <option value="Kargo Pendingin (Cold Chain)">Kargo Pendingin</option>
          </select>
        </div>

        {/* Branch */}
        <div>
          <label className="block text-slate-400 font-mono mb-1">Cabang / Depo</label>
          <select
        ...
        <div>
          ...
          >
            ...
            <option value="ASSIGNED">Ada Driver</option>
        ...
        {/* Ignition */}
        <div>
          <label className="block text-slate-400 font-mono mb-1">Ignition Kontak</label>
          <select
            value={filterState.ignition}
            onChange={(e) => onFilterChange({ ignition: e.target.value as any })}
            className="w-full bg-slate-950 border border-slate-800 rounded-xl px-2.5 py-1.5 text-white focus:outline-none focus:border-cyan-500"
          >
            <option value="ALL">Semua Ignition</option>
        ...
        <div>
          ...
          >
            ...
            <option value="80_PLUS">80+ km/jam (High Speed)</option>
          </select>
        </div>
